...
public class GumballStateMachine extends UnicastRemoteObject implements GumballMachineRemote{
		...
		public GumballStateMachine(int gumballCount, String location) throws RemoteException{
